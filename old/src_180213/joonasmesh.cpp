...
/*! \brief simple dense 3D simulation mesh class with halo regions
 *
 * Internally this is just a thin wrapper around STL vector class.
 * This means that it is dynamically allocated during runtime. For
 * fixed static arrays, consider switching `mat` to std::array<T, D>
 */
