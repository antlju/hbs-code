...
int main()
{
        ...
        */
        ...
        for (Int zi=NGHOST;zi<NZ+NGHOST;zi++)
        {
                for (Int yi=NGHOST;yi<NY+NGHOST;yi++)
                {
                        for (Int xi=NGHOST;xi<NGHOST+1;xi++)
                        {
                                
                                //cout << curluAn[vfidx(xi,yi,zi,vi)]-cu[vfidx(xi,yi,zi,vi)] << "\t";
                                cout << curluAn[vfidx(NGHOST,yi,zi,vi)] << " " << cu[vfidx(NGHOST,yi,zi,vi)] << "\t";
                                //cout << u[vfidx(xi,yi,zi,vi)] << " " << u[vfidx(xi-NGHOST,yi-NGHOST,zi-NGHOST,vi)] << "\t";
                        }
                        cout << endl;
                }
                cout << endl << "---- z step, printed x-y plane ---- " << endl << endl;
        }
        cout << "----------------- component -------------" << endl;
...
/*
        for (Int xi=NGHOST;xi<NX+NGHOST;xi++)
        {
                ...
                cout << endl << "---- x step, printed z-y plane ---- " << endl << endl;
        }
        */
